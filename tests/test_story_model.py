...
def test_story_generate_endpoint_fallback_when_no_server(client: TestClient):
    """Test POST /api/v1/story/generate returns 200 with generated story when remote server is unreachable."""
    payload = {
        "profile": {
            "age": 10,
            "grade": 5,
